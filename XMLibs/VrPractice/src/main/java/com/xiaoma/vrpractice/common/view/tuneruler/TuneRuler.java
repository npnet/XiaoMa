...
public class TuneRuler extends ViewGroup {
    ...
    public static final float AM_SCALE_FACTOR = 9f;
    public static final int FM_START = Math.round(VrPracticeConstants.FMAM.FM_START / 1000f / FM_SCALE_FACTOR);
    public static final int FM_END = Math.round(VrPracticeConstants.FMAM.FM_END / 1000f / FM_SCALE_FACTOR);
    public static final int AM_START = Math.round(VrPracticeConstants.FMAM.AM_START / AM_SCALE_FACTOR);
    public static final int AM_END = Math.round(VrPracticeConstants.FMAM.AM_END / AM_SCALE_FACTOR);

    @IntDef({VrPracticeConstants.FMAM.TYPE_FM, VrPracticeConstants.FMAM.TYPE_AM})
    @interface Mode {
    }

    private @Mode
    int mCurrentMode = VrPracticeConstants.FMAM.TYPE_FM;
    ...
    public void setMode(@Mode int mode, boolean need) {
        ...
        mMinScale = mode == VrPracticeConstants.FMAM.TYPE_FM ? FM_START : AM_START;
        mMaxScale = mode == VrPracticeConstants.FMAM.TYPE_FM ? FM_END : AM_END;
        mFactor = mode == VrPracticeConstants.FMAM.TYPE_FM ? FM_SCALE_FACTOR : AM_SCALE_FACTOR;
        refreshRuler();
    ...
    public void setCurrentScale(float scale) {
        ...
        if (mCurrentMode == VrPracticeConstants.FMAM.TYPE_FM) {
            realScale /= 1000;
        }
    ...
    public void setRulerOnTouchListener(OnTouchListener touchListener) {
