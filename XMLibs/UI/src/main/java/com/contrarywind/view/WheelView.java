    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (label !=null && label.equals("时") && halfHour){
                    String text = getContentText(visibles[counter]);
                    if (!text.equals("") && isNumeric(text)){
                        int value = Integer.parseInt(text);
                        if (value <= 12){
                            contentText = "上午" + value + label;
                        }else {
                            value-=12;
                            contentText = "下午" + value + label;
                        }
                    }
                }
...
//                    contentText = getNoLabelContentText(contentText);
...
//    private String getNoLabelContentText(String contentText){
//        String str;
//        str = contentText.replace("年", "");
//        str = str.replace("月", "");
//        str = str.replace("日", "");
//        str = str.replace("时", "");
//        str = str.replace("分", "");
