...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        wheelTime = new WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent, mPickerOptions.is24Hour);
        //设置是否需要年监听
        wheelTime.setNeedYearListener(mPickerOptions.isNeedYearListener);
        ...
        wheelTime.setItemHeight(mPickerOptions.itemHeight);
    }
