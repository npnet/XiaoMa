...
public class WheelOptions<T> {
     ...
     * 设置x轴偏移量
     */
    public void setItemHight(int height1, int height2, int height3) {
        wv_option1.setItemHeight(height1);
        wv_option1.setItemHeight(height2);
        wv_option1.setItemHeight(height3);
    }
