...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder setStartYear(int startYear){
        mPickerOptions.startYear = startYear;
        return this;
    }

    public TimePickerBuilder setEndYear(int endYear){
    ...
    public TimePickerBuilder setItemHeight(int height) {
    ...
    public TimePickerBuilder is24Hour(boolean is24Hour) {
        mPickerOptions.is24Hour = is24Hour;
        return this;
    }

    public TimePickerBuilder setNeedYearListener(boolean isNeedYearListener) {
        mPickerOptions.isNeedYearListener = isNeedYearListener;
        return this;
    }
