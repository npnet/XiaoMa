...
import com.discretescrollview.transform.DiscreteScrollItemTransformer;
import com.discretescrollview.util.ScrollListenerAdapter;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    private void init(AttributeSet attrs) {
        ...
        boolean childrenDrawingOrderEnabled = false;
        if (attrs != null) {
            ...
            childrenDrawingOrderEnabled = ta.getBoolean(R.styleable.DiscreteScrollView_drawing_order, false);
            ta.recycle();
        }
        ...
        setChildrenDrawingOrderEnabled(childrenDrawingOrderEnabled);
    ...
    protected int getChildDrawingOrder(int childCount, int i) {
        //Log.d("ljb", "getChildDrawingOrder i=" + i + ";childCount=" + childCount + ";getItemCount=" + getAdapter().getItemCount());
