...
public class  ScaleTransformer implements DiscreteScrollItemTransformer {
    ...
    private ScaleTransformerListener mScaleTransformerListener;
    ...
    public void transformItem(View item, float position) {
        ...
        Log.d("tag", "transformItem:" + item.getTag());

        if (mScaleTransformerListener != null){
            mScaleTransformerListener.onScaleTransformerDone(item, position);
        }

    }

    public void setScaleTransformerListener(ScaleTransformerListener listener){
        this.mScaleTransformerListener = listener;
    }

    public interface ScaleTransformerListener{
        void onScaleTransformerDone(View view, float position);
    }
