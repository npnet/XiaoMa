 ...
 * RecycleView 三方(com.chad.library.adapter.base.BaseQuickAdapter) item点击事件切点处理
 */
public class OnItemClickBQRvHandle extends BaseHandle {
    ...
    public void handleProceedingJoinPoint(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        KLog.d(TAG, "OnItemClickBQRvHandle value id:" + itemEvent.id + " name:" + itemEvent.name
