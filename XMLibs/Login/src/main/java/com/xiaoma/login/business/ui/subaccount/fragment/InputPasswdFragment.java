...
import static com.xiaoma.login.business.ui.subaccount.CreateSubAccountActivity.TAG_VERIFY_PHONE;
 ...
 * </p>
 */
public class InputPasswdFragment extends AbsCreateSubAccountFragment implements View.OnClickListener, NumberKeyboard.onKeyEventListener, BackHandlerHelper.FragmentBackHandler {
    ...
    public static InputPasswdFragment newInstance() {
        return new InputPasswdFragment();
    }
    ...
    protected void initView(View view) {
        ...
        verifyTitle.setText(R.string.create_sub_account);
    }
    ...
    protected void finishInputThenConfirm() {
        ...
        if (mStatus == Status.first_input) {
            ...
            if (!TextUtils.isEmpty(passwd) && passwd.equals(getPasswordText())) {
                mCreateSubAccountVM.setPasswd(passwd);
                mCreateSubAccountVM.setPageTag(TAG_VERIFY_PHONE);
                mStatus = Status.created;
            } else {
    ...
    private void refreshTips() {
        if (mStatus == Status.first_input) {
            ...
            setDescText(R.string.please_enter_your_sub_account_password);
