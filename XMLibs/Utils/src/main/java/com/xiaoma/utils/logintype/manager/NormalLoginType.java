...
public class NormalLoginType extends LoginType {
    ...
    //一般用于登录后初始化
    public NormalLoginType(AccountType accountType) {
        this(accountType, "");
    }

    // 一般用于登录时初始化
    public NormalLoginType(AccountType accountType, String userId) {
