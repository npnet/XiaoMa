 ...
 *     time  : 16/12/13
 *     desc  : utils about span(用来获取各种带简单样式的文字)
 * </pre>
 */
public final class SpanUtils {
    ...
    public static SpanUtils with(@NonNull Context context) {
    ...
    public SpanUtils setForegroundColorRes(@ColorRes final int color) {
        this.foregroundColor = mContext.getResources().getColor(color);
        return this;
    }
    ...
    public SpanUtils appendRes(@StringRes int textRes) {
        apply(mTypeCharSequence);
    ...
    public SpanUtils appendLineRes(@StringRes final int text) {
        apply(mTypeCharSequence);
        mText = text + LINE_SEPARATOR;
        return this;
    }
