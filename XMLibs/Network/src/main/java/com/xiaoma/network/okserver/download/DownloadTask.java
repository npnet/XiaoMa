 ...
 */
package com.xiaoma.network.okserver.download;
...
import com.xiaoma.network.exception.HttpException;
import com.xiaoma.network.exception.OkGoException;
import com.xiaoma.network.exception.StorageException;
...
import com.xiaoma.network.okserver.task.PriorityRunnable;
import com.xiaoma.network.request.base.Request;
import com.xiaoma.network.utils.HttpUtils;
import com.xiaoma.network.utils.IOUtils;
import com.xiaoma.network.utils.OkLogger;
...
public class DownloadTask implements Runnable {
    ...
    public ConcurrentHashMap<Object, DownloadListener> listeners;
    ...
    public void setStatues(int mStatues) {
        this.progress.status = mStatues;
    }
}
