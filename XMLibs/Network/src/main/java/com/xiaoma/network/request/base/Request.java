 ...
 */
package com.xiaoma.network.request.base;


import android.text.TextUtils;

import com.xiaoma.network.adapter.CacheCall;
import com.xiaoma.network.adapter.Call;
...
import com.xiaoma.network.convert.Converter;
import com.xiaoma.network.engine.OkGo;
import com.xiaoma.network.model.HttpHeaders;
import com.xiaoma.network.model.HttpMethod;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    protected String queryKey;      //增加缓存key，先出效果后优化
    ...
    public R priority(Priority priority) {
        if (priority != null) {
    ...
    @SuppressWarnings("unchecked")
    public R queryKey(String queryKey) {
