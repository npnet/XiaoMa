 ...
 */
package com.xiaoma.network.model;
...
public class Progress implements Serializable {
    ...
    public static final int INSTALLING = 6;  //安装中
    public static final int INSTALL_SUCCESS = 7; //安装成功
    public static final int INSTALL_FAILED = 8; //安装失败
