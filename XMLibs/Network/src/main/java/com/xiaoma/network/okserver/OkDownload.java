 ...
 */
package com.xiaoma.network.okserver;

import android.os.Environment;

import com.xiaoma.network.model.Progress;
import com.xiaoma.network.okserver.download.DownloadTask;
import com.xiaoma.network.okserver.download.DownloadThreadPool;
import com.xiaoma.network.okserver.task.XExecutor;
...
public class OkDownload {
    ...
    public static List<DownloadTask> restore(List<Progress> progressList) {
        ...
        for (Progress progress : progressList) {
            ...
            task.setStatues(progress.status);
            tasks.add(task);
        }
        return tasks;
    }
