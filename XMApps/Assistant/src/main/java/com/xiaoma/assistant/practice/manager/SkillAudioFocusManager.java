 ...
 * @date 2019/7/11
 */
public class SkillAudioFocusManager {
    private static final String TAG = SkillAudioFocusManager.class.getSimpleName();
    ...
    private static SkillAudioFocusManager instance;

    public static SkillAudioFocusManager getInstance() {
        if (instance == null) {
            synchronized (SkillAudioFocusManager.class) {
                if (instance == null) {
                    instance = new SkillAudioFocusManager();
                }
            }
        }
        return instance;
