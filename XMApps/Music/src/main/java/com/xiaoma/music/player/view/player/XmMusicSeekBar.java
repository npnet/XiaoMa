 ...
 * @date 2018/10/29
 */
public class XmMusicSeekBar extends XmSkinView{
    private static final int DEFAULT_TOTAL_WIDTH = 300;
    private static final int DEFAULT_BOTTOM_PADDING = 5;
    private static final int DEFAULT_TOP_PADDING = 30;
    ...
    public interface onSeekListener {
         ...
         * 用户触摸到控件
         */
        void onControl(boolean seek);
    }

    public XmMusicSeekBar(Context context) {
        this(context, null);
    }

    public XmMusicSeekBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XmMusicSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.XmMusicSeekBar, 0, 0);
        mMax = attributes.getInt(R.styleable.XmMusicSeekBar_max, DEFAULT_MAX);
        percent = 1f * attributes.getInt(R.styleable.XmMusicSeekBar_progress, (int) (DEFAULT_PERCENT * DEFAULT_MAX)) / DEFAULT_MAX;
        attributes.recycle();

        initView();
    }

    //是否可拖动，true可以，false不可以
     ...
     * 获取当前进度值
     *
     * @return percent 0-{@link XmMusicSeekBar#mMax}
     */
     ...
     *
     * @param toProgress 0-{@link XmMusicSeekBar#mMax}之间的进度
     */
...
//        leftFill = getContext().getResources().getDrawable(R.drawable.music_seek_bar_left_fill);
        leftFill = XmSkinManager.getInstance().getDrawable(R.drawable.music_seek_bar_left_fill);
        rightUnfill =XmSkinManager.getInstance().getDrawable(R.drawable.music_seek_bar_right_unfill);
        block = XmSkinManager.getInstance().getDrawable(R.drawable.music_seek_bar_block);
        middleFill =XmSkinManager.getInstance().getDrawable(R.drawable.music_seek_bar_middle_fill);
        middleUnfill =XmSkinManager.getInstance().getDrawable(R.drawable.music_seek_bar_middle_unfill);
//        rightUnfill = getContext().getResources().getDrawable(R.drawable.music_seek_bar_right_unfill);
//        block = getContext().getResources().getDrawable(R.drawable.music_seek_bar_block);
//        middleFill = getContext().getResources().getDrawable(R.drawable.music_seek_bar_middle_fill);
//        middleUnfill = getContext().getResources().getDrawable(R.drawable.music_seek_bar_middle_unfill);
        shadow = getContext().getResources().getDrawable(R.drawable.music_seek_bar_shadow);
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (onSeekListener != null && onScroll) {
                    ...
                    onSeekListener.onControl(false);
                    onScroll = false;
                    return false;
                }
            default:
