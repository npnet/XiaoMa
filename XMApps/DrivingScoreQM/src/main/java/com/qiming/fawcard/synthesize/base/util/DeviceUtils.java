...
public class DeviceUtils {
    ...
    public static int getStatusBarHeight(Context context) {
        ...
        int statusHeight = resources.getDimensionPixelOffset(statusBarHeightId);
        return statusHeight == 0 ? 50 : statusHeight;
    }
...
//        TelephonyManager tel = (TelephonyManager) context.getApplicationContext().getSystemService(Context
//                .TELEPHONY_SERVICE);
