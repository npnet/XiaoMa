...
public class MultyRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public MultyRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public MultyRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void check(int id) {
        ...
        mProtectFromCheckedChange = isDelayItemSelector; // 是否回调状态改变

        if (mCheckedId != -1) {// 将上一个选中取消
            setCheckedStateForView(mCheckedId, false);
        }
        if (id != -1) { // 选中当前项
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MultyRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MultyRadioGroup.class.getName());
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(MultyRadioGroup group, int checkedId);
    }
    ...
    private class CheckedStateTracker implements CompoundButton.OnCheckedChangeListener {
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if (isDelayItemSelector) { // 回调 但选中的item不变
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == MultyRadioGroup.this) {
                List<RadioButton> btns = getAllRadioButton(child);
                if (btns != null && btns.size() > 0) {
