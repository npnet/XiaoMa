 ...
 * @date 2018/12/5
 */
@PageDescComponent(EventConstants.PageDescribe.FRAGMENT_LOCAL_PLAYER_SWITCH)
public class LocalSwitchFragment extends AbsLocalFragment {

    public static LocalSwitchFragment newInstance() {
        return new LocalSwitchFragment();
    }
    ...
    protected void getData() {
        mVM.getSwitch();
        mVM.getSwitchList().observe(this, new Observer<List<BaseChannelBean>>() {
