 ...
 * @date 2018/10/13
 */
public class XMRadioListByCategory extends XMBean<RadioListByCategory> {
    public XMRadioListByCategory(RadioListByCategory radioListByCategory) {
        super(radioListByCategory);
    }
