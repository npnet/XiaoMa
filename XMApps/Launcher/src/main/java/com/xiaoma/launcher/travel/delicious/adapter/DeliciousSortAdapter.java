...
public class DeliciousSortAdapter extends XMBaseAbstractBQAdapter<CategoryBean.SubcateBean, BaseViewHolder> {

    private TextView mSortname;

    public DeliciousSortAdapter() {
    ...
    private void initView(BaseViewHolder helper, final CategoryBean.SubcateBean item) {
        ...
        helper.itemView.setOnClickListener(new XMAutoTrackerEventOnClickListener() {
            ...
            public ItemEvent returnPositionEventMsg(View view) {
                return new ItemEvent(EventConstants.NormalClick.DELICIOUS_SORT,String.valueOf(item.getName()));
            }
            ...
            public void onClick(View v) {
                ...
                if(LanguageUtils.isChinese(mContext)){
                    launcherDeliciousActivity(item.getName(),item.getName(), String.valueOf(item.getId()));
                }else{
                    launcherDeliciousActivity(item.getName(),item.getNameEn(), String.valueOf(item.getId()));
                }
            }
        });
    ...
    private void launcherDeliciousActivity(String searchKey,String display, String cateId) {
