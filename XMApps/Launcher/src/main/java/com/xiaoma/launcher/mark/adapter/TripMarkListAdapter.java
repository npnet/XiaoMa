...
import com.xiaoma.launcher.mark.ui.fragment.TripMarkListFragment;
...
public class TripMarkListAdapter extends XMBaseAbstractBQAdapter<MarkPhotoBean, BaseViewHolder> {

    public boolean editType = false;
    public MarkMainActivity mMarkMainActivity;
    public TripMarkListFragment mTripMarkListFragment;

    public TripMarkListAdapter(TripMarkListFragment tripMarkListFragment, MarkMainActivity markMainActivity) {
    ...
    protected void convert(final BaseViewHolder helper, final MarkPhotoBean item) {
        ...
        helper.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TripDateilsFragment tripDateilsFragment = TripDateilsFragment.newInstance(mTripMarkListFragment, null, mMarkMainActivity);
        ...
        dialog.setContent(mContext.getString(R.string.mark_clean_message))
                .setPositiveButton(mContext.getString(R.string.mark_clean_ok), new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mTripMarkListFragment.adapterDeleteListener(item);
