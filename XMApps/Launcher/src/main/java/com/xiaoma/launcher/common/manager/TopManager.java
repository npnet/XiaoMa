 ...
 * @date 2019/6/22
 */
public class TopManager extends LinearLayoutManager {
    public TopManager(Context context) {
        super(context);
    }

    public TopManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
    }

    public TopManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
