...
public class RepositoryFragment extends BaseFragment {
    ...
    public static RepositoryFragment newFragmentInstance() {
    ...
    private void initView(View contentView) {
        ...
        fragments[0] = RepositoryGoodsFragment.newInstance(GoodsType.FOOD);
        fragments[1] = RepositoryGoodsFragment.newInstance(GoodsType.DECORATOR);
        fragments[2] = RepositoryGoodsFragment.newInstance(GoodsType.COS_PLAY);
    ...
    private void setupTabItemView() {
        ...
        mItemViewHolder = new RepositoryFragment.TabItemViewHolder[tabCount];
        //初始化tab
        for (int index = 0; index < tabCount; index++) {
            ...
            if (tab != null) {
                ...
                if (tabView != null) {
                    mItemViewHolder[index] = new RepositoryFragment.TabItemViewHolder(tabView);
