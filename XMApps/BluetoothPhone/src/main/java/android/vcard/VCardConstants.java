...
public class VCardConstants {
    /* package */ public static final String LOG_TAG = "vCard";
    ...
    /* package */ public static final String PARAM_TYPE_X_IRMC_N = "X-IRMC-N";

    // Used in unit test.
    public static final int MAX_DATA_COLUMN = 15;

    /* package */ static final int MAX_CHARACTER_NUMS_QP = 76;
    public static final int MAX_CHARACTER_NUMS_BASE64_V30 = 75;

    public static final String PROPERTY_X_IRMC_CALL_DATETIME = "X-IRMC-CALL-DATETIME";


    public static final String X_GROUP_MEMBERSHIP = "X-GROUP-MEMBERSHIP";
