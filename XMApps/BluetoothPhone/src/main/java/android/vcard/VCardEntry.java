...
public class VCardEntry {
    ...
    public static class PhoneData implements EntryElement {
        ...
        public PhoneData(String data, int type, String label, boolean isPrimary, String phoneType) {
            mNumber = data;
            mType = type;
            mLabel = label;
    ...
    public static class WebsiteData implements EntryElement {
        ...
        public void constructInsertOperation(List<ContentProviderOperation> operationList,
            ...
            // There's no information about the type of URL in
    ...
    public static class Membership implements EntryElement{
        ...
        @Override
        public boolean isEmpty() {
            return TextUtils.isEmpty(member);
        }
    ...
    private CallDatetimeData mCallDatetimeData;
    ...
    private void addPhone(int type, String data, String label, boolean isPrimary, String phoneType) {
        if (mPhoneList == null) {
        ...
        PhoneData phoneData = new PhoneData(formattedNumber, type, label, isPrimary, phoneType);
    ...
    public void addProperty(final VCardProperty property) {
        ...
        if (propertyName.equals(VCardConstants.PROPERTY_VERSION)) {
            ...
            if (isSip) {
                ...
                if (typeCollection != null && typeCollection.size() != 0) {
                    Object[] objects = typeCollection.toArray();
                    phoneType = objects[0].toString();
                    KLog.d("phoneNum: " + phoneNumber + ", phoneType: " + phoneType);
                }
                addPhone(type, phoneNumber, label, isPrimary, phoneType);
            }
            ...
            addPhone(type, propValue, null, isPrimary, null);
        ...
        }else if (propertyName.equals(VCardConstants.PROPERTY_X_IRMC_CALL_DATETIME)) {
            mCallDatetimeData = new CallDatetimeData(propValue);
        } else if (propertyName.equals(VCardConstants.X_GROUP_MEMBERSHIP)){
//            addMembership(new Membership(propValue));
            memberships = new Membership(propValue);
    ...
    public String  getMember(){
        return memberships != null ?memberships.getMember():null;
    }
}
