...
public class TxVideoPlayerController extends NiceVideoPlayerController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private PlayerStatusChangeCallback playerStatusChangeCallback;
...
//                startDismissControlViewTimer();
        ...
        if (playerStatusChangeCallback != null){
            playerStatusChangeCallback.onPlayerStatusChange(playState);
        }
    }
...
//        }
    ...
    public void setPlayerStatusChangeListener(PlayerStatusChangeCallback playerStatusChangeCallback){
        this.playerStatusChangeCallback = playerStatusChangeCallback;
    }
}
