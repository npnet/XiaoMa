...
//    private GestureDetector mGesture;
    ...
    public abstract void hideTopBottomView(boolean isHideView);


    public NiceVideoPlayerController(final Activity context) {
        super(context);
        mContext = context;
...
//                            mGestureDownVolume = mNiceVideoPlayer.getVolume();
                ...
                if (mNeedChangePosition && !mNiceVideoPlayer.isError()) {
...
//                }
    ...
    protected void startDismissTopBottomView() {
        mContext.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                hideTopBottomView(isHideView);
            }
        });
    ...
    protected void startDismissControlViewTimer() {
        ...
        mDismissControlViewTimer.schedule(mDismissControlViewTimerTask, 3000);
    }
