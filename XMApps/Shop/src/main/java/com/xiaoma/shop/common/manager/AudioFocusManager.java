...
public class AudioFocusManager {
    ...
    private AudioFocusManager() {
        mAudioManager = (AudioManager) Shop.getInstance().getApplication().getSystemService(Context.AUDIO_SERVICE);
        mIAudioFocusListeners = new ArrayList<>();
    }

    private static class Holder {
        private static AudioFocusManager sAudioFocusManager = new AudioFocusManager();
    }

    public static AudioFocusManager getInstance() {
        return Holder.sAudioFocusManager;
    }
