...
public class UnitConverUtils {
    ...
    public static long string2Long(String productId) {
        long ret = 0;
        try {
            ret =  Long.parseLong(productId);
        } catch (NumberFormatException e) {
            e.printStackTrace();
        }
        return ret;
    }
    public static float string2Float(String productId) {
        float ret = 0;
        try {
            ret =  Float.parseFloat(productId);
        } catch (NumberFormatException e) {
            e.printStackTrace();
        }
        return ret;
